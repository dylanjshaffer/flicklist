...
var api = {
  ...
  token: "24758e2d6d872edf774b8e3777b4d0de", // TODO 0 add your api key (DONE)
  /**
...
function render() {
  ...
  $("#add-to-watchlist")
    ...
    var posters = model.browseItems.map(function(movie) {
      ...
      var poster = $("<img></img>").attr("src", api.posterUrl(movie)).attr("class", "img-responsive");

      return $("<li></li>").attr("class", "item").append(poster);
